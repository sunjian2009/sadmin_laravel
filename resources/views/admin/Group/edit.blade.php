...
<div class="page-container">
    <form class="form form-horizontal" id="form" method="post" action="{{url('admin/group/edit')}}">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="text" class="input-text" value="{{ isset($vo['icon']) ? htmlspecialchars($vo['icon']) : '' }}"
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <input type="number" class="input-text" value="{{$vo['sort'] or 50}}" placeholder=""
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6 skin-minimal">
                <div class="radio-box">
                    <input type="radio" name="status" id="radio-0" value="1" @if ($vo['status'] == 1)checked @endif>
                    <label for="radio-0">启用</label>
                </div>
                <div class="radio-box">
                    <input type="radio" name="status" id="radio-1" value="0" @if ($vo['status'] == 0)checked @endif>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-6 col-sm-6">
                <textarea class="textarea" placeholder="备注" name="remark" onKeyUp="textarealength(this, 100)">{{$vo['remark'] or ''}}</textarea>
