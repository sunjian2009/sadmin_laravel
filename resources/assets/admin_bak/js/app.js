...
$(function () {
    ...
    $(".Hui-aside").on("click", ".menu_dropdown [data-href]", function () {
        $(".Hui-aside .menu_dropdown [data-href]").removeClass('focus');
        $(this).addClass('focus');
        Hui_admin_tab(this);
    });

    /* 生成面包屑导航 */
    $(".Hui-aside .menu_dropdown [data-href]").each(function () {
        var nav = $(this).html();
        var tmp_node = $(this);
...
function saveOrder(url, select) {
    ...
    ajax_req(url || APP_CONTROLLER + '/saveOrder', {'sort': data});
}
